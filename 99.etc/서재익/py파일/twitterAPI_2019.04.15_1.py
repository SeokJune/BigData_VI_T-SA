...
class TwitterAPI :
    ...
    def keyword_result(self, tweets):
        ...
        json['created_at']=np.array([tweet.created_at])        
        json["id"]   = np.array([tweet.id])
        json['id_str'] = np.array([tweet.id_str])
        json["text"] = np.array([tweet.text])
        json["truncated"]   = np.array([tweet.truncated])
        json['entities'] = np.array([tweet.entities])
        json['metadata'] = np.array([tweet.metadata])
        json['source'] = np.array([tweet.source])
        json['in_reply_to_status_id'] = np.array([tweet.in_reply_to_status_id])
        json['in_reply_to_status_id_str'] = np.array([tweet.in_reply_to_status_id_str])
        json['in_reply_to_user_id'] = np.array([tweet.in_reply_to_user_id])
        json['in_reply_to_user_id_str'] = np.array([tweet.in_reply_to_user_id_str])
        json['in_reply_to_screen_name'] = np.array([tweet.in_reply_to_screen_name])
        json['geo'] = np.array([tweet.geo])
        json['coordinates'] = np.array([tweet.coordinates])
        json['place'] = np.array([tweet.place])
        json['contributors'] = np.array([tweet.contributors])
        json['is_quote_status'] = np.array([tweet.is_quote_status])
        json['retweet_count'] = np.array([tweet.retweet_count])
        json['favorite_count'] = np.array([tweet.favorite_count])
        json['favorited'] = np.array([tweet.favorited])
        json['retweeted'] = np.array([tweet.retweeted])
        json['lang'] = np.array([tweet.lang])
        json["source_url"]   = np.array([tweet.source_url])
   ...
   #     df["status"] = np.array([user.status])     
    ...
    #    df["hashtags"] = np.array([user.status.entities.get('hashtags')])
    #    df["symbols"] = np.array([user.status.entities.get('symbols')])
    #    df["user_mentions"] = np.array([user.status.entities.get('user_mentions')])
    #    df["urls"] = np.array([user.status.entities.get('urls')])
