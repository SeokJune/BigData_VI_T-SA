...
public class KeywordCountMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, Text, IntWritable>.Context context)
        ...
        //------------------------------------자연어 처리부분-----------------------------------------
    	//Normalize
    	CharSequence normalized = OpenKoreanTextProcessorJava.normalize(value.toString());
    	//Tokenize
       Seq<KoreanTokenizer.KoreanToken> tokens = OpenKoreanTextProcessorJava.tokenize(normalized);
       List<String> list_token = OpenKoreanTextProcessorJava.tokensToJavaStringList(tokens);
       Iterator<String> itr = list_token.iterator();
       //------------------------------------------------------------------------------------------
