...
Title = (('Twitter',
         ...
         ('Hadoop',
          'Sqoop(Import/keyword)', 'Sqoop(Import/Hashtag)',
          'Map/Reduce(keyword)', 'Map/Reduce(Hashtag)',
          'Sqoop(Export/keyword)', 'Sqoop(Export/Hashtag)'),
         ('Visualization(Base)',
